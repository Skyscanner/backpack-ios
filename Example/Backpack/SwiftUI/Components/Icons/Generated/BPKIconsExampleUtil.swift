...
extension IconsViewController {
    static var allIcons: [String] {
        [
            ...
            "vdl-home-hotels",
            "vdl-hotels",
            "vdl-tab-drops-selected",
            "vdl-tab-drops",
            "vdl-tab-profile-selected",
            "vdl-tab-profile",
            "vdl-tab-saved-selected",
            "vdl-tab-saved",
            "vdl-tab-search-selected",
            "vdl_tab-search",
            "view",
            "virus",
            "walk",
...
struct IconsExampleViewContent {
    static let allIcons: [Backpack_SwiftUI.BPKIcon] = [
        ...
        .vdlTabDropsSelected,
        .vdlTabDrops,
        .vdlTabProfileSelected,
        .vdlTabProfile,
        .vdlTabSavedSelected,
        .vdlTabSaved,
        .vdlTabSearchSelected,
        .vdlTabSearch,
        .view,
        .virus,
        .walk,
