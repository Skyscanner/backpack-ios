...
#define BPKVerifySnapshotOS()                                                                                          \
    {                                                                                                                  \
        ...
        NSString *actualOSVersion =                                                                                    \
            [NSString stringWithFormat:@"%ld.%ld", deviceOSVersion.majorVersion, deviceOSVersion.minorVersion];        \
        XCTAssertTrue(validDevice,                                                                                     \
                      @"Snapshot tests are only valid on an %@ running iOS %@. Device was %@ running iOS %@.",         \
                      correctDeviceName, correctOSVersion, deviceName, actualOSVersion);                               \
    }
