...
- (void)testDialogViewWithButtons {
    BPKDialogIconDefinition *iconDefinition =
        [[BPKDialogIconDefinition alloc] initWithIcon:[BPKIcon largeTemplateIconNamed:BPKLargeIconNameLightning]
...
- (void)testChangingIconDefinitionAfterPresenting {
    ...
    BPKDialogIconDefinition *newIconDefinition =
        [[BPKDialogIconDefinition alloc] initWithIcon:[BPKIcon largeTemplateIconNamed:BPKLargeIconNameKey]
