...
class SwiftUIScreenshots: BackpackSnapshotTestCase {
    ...
    func captureAllScreenshots(userInterfaceStyle: UIUserInterfaceStyle = .light) {
        ...
        navigate(title: "Card list") {
            switchTab(title: "SwiftUI")
            app.tables.staticTexts["Rail - 5 total elements"].tap()
            saveScreenshot(component: "card-list", scenario: "rail-5-elements", userInterfaceStyle: userInterfaceStyle)
            tapBackButton()
            app.tables.staticTexts["Rail - 12 total elements"].tap()
            saveScreenshot(component: "card-list", scenario: "rail-12-elements", userInterfaceStyle: userInterfaceStyle)
            tapBackButton()
