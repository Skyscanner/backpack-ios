...
* `cocoapods` publishing the podspecs to the CocoaPods trunk. Deprecated, and used only by the release workflow; it is no longer part of the build, test or documentation pipelines.
