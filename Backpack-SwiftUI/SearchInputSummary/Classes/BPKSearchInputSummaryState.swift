...
extension BPKSearchInputSummary {
    ...
    public enum State {
        ...
        var icon: BPKSearchInputSummary.Icon? {
            switch self {
            case .clear: return BPKSearchInputSummary.Icon(icon: .closeCircle, color: .textSecondaryColor)
            case .valid: return BPKSearchInputSummary.Icon(icon: .tickCircle, color: .statusSuccessSpotColor)
            case .error: return BPKSearchInputSummary.Icon(icon: .exclamationCircle, color: .statusDangerSpotColor)
            default: return nil
            }
        }
    }
