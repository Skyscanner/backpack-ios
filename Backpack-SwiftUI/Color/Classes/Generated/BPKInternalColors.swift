...
internal extension BPKColor {
    ...
    static let chipOnDarkOnFillColor = BPKColor(red: 0.082, green: 0.275, blue: 0.475, alpha: 1)
    ...
    static let buttonSecondaryOnDarkPressedBackgroundColor = BPKColor(red: 0.016, green: 0.094, blue: 0.176, alpha: 1)
        .darkVariant(BPKColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.2))
    ...
    static let navigationTabOnDarkOutlineColor = BPKColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.2)
        .darkVariant(BPKColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.2))
    ...
    static let segmentedControlCanvasDefaultColor = BPKColor(red: 0.937, green: 0.953, blue: 0.973, alpha: 1)
        .darkVariant(BPKColor(red: 0.075, green: 0.114, blue: 0.169, alpha: 1))

    /// The `segmentedControlSurfaceContrastColor` internal color.
    
    static let segmentedControlSurfaceContrastColor = BPKColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.10196078431372549)
        .darkVariant(BPKColor(red: 0.075, green: 0.114, blue: 0.169, alpha: 1))

    /// The `segmentedControlSurfaceContrastOnColor` internal color.
    
    static let segmentedControlSurfaceContrastOnColor = BPKColor(red: 0.008, green: 0.302, blue: 0.686, alpha: 1)
        .darkVariant(BPKColor(red: 0.020, green: 0.255, blue: 0.518, alpha: 1))

    /// The `pageIndicatorButtonCarouselNormalBackgroundColor` internal color.
    
    static let pageIndicatorButtonCarouselNormalBackgroundColor = BPKColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.5019607843137255)
        .darkVariant(BPKColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.5019607843137255))
