...
/// does not run with one. Layout and legend are shared: NativeCompareSupport.swift.
typealias NativeCompareButtonView = NativeCompareView<ButtonComparison>

/// One comparison: header, the pair in enabled and disabled state, and the colour legend.
typealias NativeCompareButtonRow = NativeCompareRow<ButtonComparison>
