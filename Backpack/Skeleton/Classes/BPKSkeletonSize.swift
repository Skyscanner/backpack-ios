...
internal extension BPKSkeletonSize {
    ...
    var headline: CGSize {
        ...
        case .custom(let customSize):
            return customSize
        case .small:
            return CGSize(width: 80, height: BPKSpacingMd)
        case .`default`:
            return CGSize(width: 80, height: BPKSpacingBase)
        case .large:
            return CGSize(width: 80, height: BPKSpacingXl)
        }
    }
    ...
    var bodytext: CGSize {
        ...
        case .custom(let customSize):
            return customSize
        default:
            return CGSize(width: 200, height: BPKSpacingXxl)
        }
    }
}
