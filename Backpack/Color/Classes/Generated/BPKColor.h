...
*/
@property(nonatomic, class, readonly) UIColor * coreEcoColor __deprecated;
 ...
 *
 * <div style="width: 100px; height: 100px; background-color: #ffffff1a; background: linear-gradient(0.375turn, #ffffff1a 49%, #ffffff1a 50%); box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3); border-radius: 6px;"></div>
*/
@property(nonatomic, class, readonly) UIColor * surfaceTintColor;
 ...
 * <div style="width: 100px; height: 100px; background-color: #0062e3ff; background: linear-gradient(0.375turn, #0062e3ff 49%, #84e9ffff 50%); box-shadow: 0px 1px 3px 0px rgba(37,32,31,.3); border-radius: 6px;"></div>
*/
@property(nonatomic, class, readonly) UIColor * textLinkColor __deprecated;
