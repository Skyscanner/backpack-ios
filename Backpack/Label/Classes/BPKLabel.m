...
// SPM-only implementation. For CocoaPods, BPKLabel.swift is used instead.
// This is needed because SPM cannot mix ObjC and Swift in a single target,
// and the ObjC target (Backpack_ObjC) references BPKLabel directly.
#ifdef SWIFT_PACKAGE
