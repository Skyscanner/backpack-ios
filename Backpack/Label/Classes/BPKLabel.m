...
- (void)updateTextStyle {
    ...
    NSMutableAttributedString *newAttributedString = [[BPKFont attributedStringFromStyle:self.fontStyle andColor:self.textColor onAttributedString:self.attributedText] mutableCopy];
