...
images.each do |image|
  ...
  destinationFileDirectory = File.join(targetScreenshotDirectory, componentName)
  system "mkdir -p \"#{destinationFileDirectory}\""
  destinationFile = File.join(destinationFileDirectory, "#{scenarioName}.png")
