...
1. Update `Example/Backpack Screenshot/SwiftUIScreenshots` to capture screenshots of the new componenet. Please note that the screenshots will appear as they do in the component entry in Stories. 
